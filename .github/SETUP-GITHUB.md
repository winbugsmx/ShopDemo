...
Completar post-script AKS/EKS según [GUIA-RELEASE-SCRIPT-AZURE](../Documentación_Del_Proyecto/despliegue/azure/GUIA-RELEASE-SCRIPT-AZURE.md) y [GUIA-RELEASE-SCRIPT-AWS](../Documentación_Del_Proyecto/despliegue/aws/GUIA-RELEASE-SCRIPT-AWS.md).
...
Ver [PREPARACION-AMBIENTE-AWS.md](../Documentación_Del_Proyecto/despliegue/aws/PREPARACION-AMBIENTE-AWS.md) y políticas en `Source/scripts/aws/iam-policy-shopdemo-lab-*.json`.
...
- [ALCANCE-LAB-RELEASE.md](../Documentación_Del_Proyecto/despliegue/ALCANCE-LAB-RELEASE.md) — CI/CD § merge a main
