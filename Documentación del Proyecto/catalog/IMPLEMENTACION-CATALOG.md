...
> Este documento describe paso a paso la implementación **real** del microservicio Catalog. Los alumnos deben seguir `REQUERIMIENTOS-CATALOG.md` y usar este documento para validar su solución contra el código en `Source/Catalog/`.
...
dotnet new classlib -n ShopDemo.Catalog.Domain -o Source/Catalog/ShopDemo.Catalog.Domain -f net10.0
dotnet new classlib -n ShopDemo.Catalog.Application -o Source/Catalog/ShopDemo.Catalog.Application -f net10.0
dotnet new classlib -n ShopDemo.Catalog.Infraestructure -o Source/Catalog/ShopDemo.Catalog.Infraestructure -f net10.0
dotnet new webapi -n ShopDemo.Catalog.Api -o Source/Catalog/ShopDemo.Catalog.Api -f net10.0

# Domain
dotnet add Source/Catalog/ShopDemo.Catalog.Domain/ShopDemo.Catalog.Domain.csproj reference Source/ShopDemo.Shared/ShopDemo.Shared.csproj

# Application
dotnet add Source/Catalog/ShopDemo.Catalog.Application/ShopDemo.Catalog.Application.csproj reference Source/Catalog/ShopDemo.Catalog.Domain/ShopDemo.Catalog.Domain.csproj
dotnet add Source/Catalog/ShopDemo.Catalog.Application/ShopDemo.Catalog.Application.csproj package MediatR
dotnet add Source/Catalog/ShopDemo.Catalog.Application/ShopDemo.Catalog.Application.csproj package FluentValidation
dotnet add Source/Catalog/ShopDemo.Catalog.Application/ShopDemo.Catalog.Application.csproj package FluentValidation.DependencyInjectionExtensions

# Infrastructure
dotnet add Source/Catalog/ShopDemo.Catalog.Infraestructure/ShopDemo.Catalog.Infraestructure.csproj reference Source/Catalog/ShopDemo.Catalog.Application/ShopDemo.Catalog.Application.csproj
dotnet add Source/Catalog/ShopDemo.Catalog.Infraestructure/ShopDemo.Catalog.Infraestructure.csproj reference Source/Catalog/ShopDemo.Catalog.Domain/ShopDemo.Catalog.Domain.csproj
dotnet add Source/Catalog/ShopDemo.Catalog.Infraestructure/ShopDemo.Catalog.Infraestructure.csproj reference Source/ShopDemo.Shared/ShopDemo.Shared.csproj
dotnet add Source/Catalog/ShopDemo.Catalog.Infraestructure/ShopDemo.Catalog.Infraestructure.csproj package Microsoft.EntityFrameworkCore
dotnet add Source/Catalog/ShopDemo.Catalog.Infraestructure/ShopDemo.Catalog.Infraestructure.csproj package Npgsql.EntityFrameworkCore.PostgreSQL

# Api
dotnet add Source/Catalog/ShopDemo.Catalog.Api/ShopDemo.Catalog.Api.csproj reference Source/Catalog/ShopDemo.Catalog.Infraestructure/ShopDemo.Catalog.Infraestructure.csproj
dotnet add Source/Catalog/ShopDemo.Catalog.Api/ShopDemo.Catalog.Api.csproj reference Source/Catalog/ShopDemo.Catalog.Application/ShopDemo.Catalog.Application.csproj
dotnet add Source/Catalog/ShopDemo.Catalog.Api/ShopDemo.Catalog.Api.csproj package Swashbuckle.AspNetCore
dotnet add Source/Catalog/ShopDemo.Catalog.Api/ShopDemo.Catalog.Api.csproj package Microsoft.EntityFrameworkCore.Design
```

### 2.3 Agregar a la solución

En `Source/ShopDemo.slnx`, carpeta `/Catalog/` con los cuatro proyectos.

---

## 3. Shared Kernel

**Ubicación:** `Source/ShopDemo.Shared/Domain/`
...
**Archivo:** `Source/Catalog/ShopDemo.Catalog.Domain/ValueObjects/Money.cs`
...
**Archivo:** `Source/Catalog/ShopDemo.Catalog.Domain/Aggregates/Product.cs`
...
**Ubicación:** `Source/Catalog/ShopDemo.Catalog.Domain/Events/`
...
**Archivo:** `Source/Catalog/ShopDemo.Catalog.Domain/Repositories/IProductRepository.cs`
...
**Archivo:** `Source/Catalog/ShopDemo.Catalog.Application/Commands/CreateProduct/CreateProductCommand.cs`
...
**Archivo:** `Source/Catalog/ShopDemo.Catalog.Application/Common/Behaviors/ValidationBehavior.cs`
...
**Archivo:** `Source/Catalog/ShopDemo.Catalog.Application/Commands/CreateProduct/CreateProductHandler.cs`
...
**Archivo:** `Source/Catalog/ShopDemo.Catalog.Application/DTOs/ProductDto.cs`
...
**Archivo:** `Source/Catalog/ShopDemo.Catalog.Application/Ports/IDomainEventPublisher.cs`
...
**Archivo:** `Source/Catalog/ShopDemo.Catalog.Infraestructure/Persistence/CatalogDbContext.cs`
...
**Archivo:** `Source/Catalog/ShopDemo.Catalog.Infraestructure/Persistence/Configurations/ProductConfiguration.cs`
...
**Archivo:** `Source/Catalog/ShopDemo.Catalog.Infraestructure/Messaging/LoggingDomainEventPublisher.cs`
...
**Archivo:** `Source/Catalog/ShopDemo.Catalog.Api/Controllers/ProductsController.cs`
...
**Archivo:** `Source/Catalog/ShopDemo.Catalog.Api/Middleware/ExceptionHandlingMiddleware.cs`
...
**Archivo:** `Source/Catalog/ShopDemo.Catalog.Api/Program.cs`
...
> **Copiar del repo:** los archivos completos están en `Source/Catalog/ShopDemo.Catalog.Api/`. Si construyes desde cero, copia exactamente estas rutas.

### 8.1 `docker-compose.yml`

**Ubicación:** `Source/Catalog/ShopDemo.Catalog.Api/docker-compose.yml`
...
**Ubicación:** `Source/Catalog/ShopDemo.Catalog.Api/Dockerfile` — build multi-stage (.NET 10), contexto `Source/Catalog/`, usuario no-root `USER app`, puerto `8080`.
...
# ... stages build + publish desde Source/Catalog/
USER app
...
`Source/Catalog/ShopDemo.Catalog.Api/docker/postgres/init/` — permisos en schema `public` para el usuario `ShopDemo`.
...
2. `dotnet run --project Source/Catalog/ShopDemo.Catalog.Api`
