...
- [Teoría lab Docker/K8s](../TEORIA-DOCKER-KUBERNETES-AOT.md)
- **Tópicos de Estudio:** [07 — Contenedores y Docker](../../Documentación de Estudio del Curso/07-contenedores-docker.md) · [08 — Kubernetes](../../Documentación de Estudio del Curso/08-kubernetes-orquestacion.md) · [Índice completo](../../Documentación de Estudio del Curso/README.md)
