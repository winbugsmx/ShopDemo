...
| [kubectl](https://kubernetes.io/Documentación del Proyecto/tasks/tools/) | 1.28+ | EKS | `kubectl version --client` |
| [Helm](https://helm.sh/Documentación del Proyecto/intro/install/) | 3.x | EKS (opcional; perfil lab sin Ingress) | `helm version` |
...
|---|---|---|
| **ShopDemoLabECS** | [`Source/scripts/aws/iam-policy-shopdemo-lab-ecs.json`](../../../Source/scripts/aws/iam-policy-shopdemo-lab-ecs.json) | `ShopDemoLabECS` |
...
| Política | Archivo | Nombre en IAM |
|---|---|---|
| **ShopDemoLabEKS** | [`Source/scripts/aws/iam-policy-shopdemo-lab-eks.json`](../../../Source/scripts/aws/iam-policy-shopdemo-lab-eks.json) | `ShopDemoLabEKS` |
