...
docker build -f Source/Catalog/ShopDemo.Catalog.Api/Dockerfile -t "${ACR_LOGIN}/shopdemo-catalog:${TAG}" .
docker push "${ACR_LOGIN}/shopdemo-catalog:${TAG}"

docker build -f Source/Orders/ShopDemo.Orders.Api/Dockerfile -t "${ACR_LOGIN}/shopdemo-orders:${TAG}" .
docker push "${ACR_LOGIN}/shopdemo-orders:${TAG}"

docker build -f Source/Inventory/ShopDemo.Inventory.Api/Dockerfile -t "${ACR_LOGIN}/shopdemo-inventory:${TAG}" .
docker push "${ACR_LOGIN}/shopdemo-inventory:${TAG}"

docker build -f Source/Aspire/ShopDemo.Analytics.Api/Dockerfile -t "${ACR_LOGIN}/shopdemo-analytics:${TAG}" .
docker push "${ACR_LOGIN}/shopdemo-analytics:${TAG}"

docker build -f Source/AI/ShopDemo.Mcp.Api/Dockerfile -t "${ACR_LOGIN}/shopdemo-mcp:${TAG}" .
