...
Reporte lab: [deploy-aks-report.json](../../../Source/scripts/azure/deploy-aks-report.json)
...
| Classic ELB (K8s LoadBalancer) | Automático (Source/Catalog, Source/Orders, Source/Inventory) |
