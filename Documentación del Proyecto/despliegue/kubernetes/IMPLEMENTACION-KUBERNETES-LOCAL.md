...
| Dockerfiles | `Source/Catalog/`, `Source/Orders/`, `Source/Inventory/`, `Analytics/`, `Source/AI/` | Imágenes que referencian los Deployments |
...
- Docker Desktop
- [Minikube](https://minikube.sigs.k8s.io/Documentación del Proyecto/start/) instalado
- `kubectl` instalado
- ShopDemo clonado
...
Repetir mentalmente para Source/Orders/Inventory o confiar en el build del paso 5.  
...
docker build -f Source/Catalog/ShopDemo.Catalog.Api/Dockerfile -t shopdemo-catalog:latest .
docker build -f Source/Orders/ShopDemo.Orders.Api/Dockerfile -t shopdemo-orders:latest .
docker build -f Source/Inventory/ShopDemo.Inventory.Api/Dockerfile -t shopdemo-inventory:latest .
