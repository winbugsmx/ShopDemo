...
**Componente:** `Source/AI/ShopDemo.Mcp.Api` · **Requerimientos:** [REQUERIMIENTOS-DESPLIEGUE-MCP.md](./REQUERIMIENTOS-DESPLIEGUE-MCP.md)  
...
docker build -f Source/AI/ShopDemo.Mcp.Api/Dockerfile -t $ACR_LOGIN/shopdemo-mcp:v1 .
docker push $ACR_LOGIN/shopdemo-mcp:v1
```

**Explicación:** El Dockerfile usa contexto raíz del repo; no requiere proyectos Source/Catalog/Orders.
...
| 3 | Tool `GetShopDemoStatus` | JSON con Source/Catalog, Source/Inventory y Analytics OK |
...
```yaml
- service: mcp
  dockerfile: Source/AI/ShopDemo.Mcp.Api/Dockerfile
  image: shopdemo-mcp
