...
| 2 | `dotnet run --project Source/AI/ShopDemo.Mcp.Api` |
...
**Explicación:** El agente descubre tools por el protocolo MCP; no necesita conocer URLs de Source/Catalog/Inventory.
