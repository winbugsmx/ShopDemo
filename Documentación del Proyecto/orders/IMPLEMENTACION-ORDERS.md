...
dotnet new classlib -n ShopDemo.Orders.Domain -o Source/Orders/ShopDemo.Orders.Domain -f net10.0
dotnet new classlib -n ShopDemo.Orders.Application -o Source/Orders/ShopDemo.Orders.Application -f net10.0
dotnet new classlib -n ShopDemo.Orders.Infraestructure -o Source/Orders/ShopDemo.Orders.Infraestructure -f net10.0
dotnet new webapi -n ShopDemo.Orders.Api -o Source/Orders/ShopDemo.Orders.Api -f net10.0
```

En `Source/ShopDemo.slnx`, agrega carpeta `/Orders/` con los cuatro proyectos (ver [IMPLEMENTACION-CATALOG §2.3](../catalog/IMPLEMENTACION-CATALOG.md#23-agregar-a-la-solución)).
...
# Domain
dotnet add Source/Orders/ShopDemo.Orders.Domain/ShopDemo.Orders.Domain.csproj reference Source/ShopDemo.Shared/ShopDemo.Shared.csproj

# Application
dotnet add Source/Orders/ShopDemo.Orders.Application/ShopDemo.Orders.Application.csproj reference Source/Orders/ShopDemo.Orders.Domain/ShopDemo.Orders.Domain.csproj
dotnet add Source/Orders/ShopDemo.Orders.Application/ShopDemo.Orders.Application.csproj package MediatR
dotnet add Source/Orders/ShopDemo.Orders.Application/ShopDemo.Orders.Application.csproj package FluentValidation
dotnet add Source/Orders/ShopDemo.Orders.Application/ShopDemo.Orders.Application.csproj package FluentValidation.DependencyInjectionExtensions

# Infrastructure
dotnet add Source/Orders/ShopDemo.Orders.Infraestructure/ShopDemo.Orders.Infraestructure.csproj reference Source/Orders/ShopDemo.Orders.Application/ShopDemo.Orders.Application.csproj
dotnet add Source/Orders/ShopDemo.Orders.Infraestructure/ShopDemo.Orders.Infraestructure.csproj reference Source/Orders/ShopDemo.Orders.Domain/ShopDemo.Orders.Domain.csproj
dotnet add Source/Orders/ShopDemo.Orders.Infraestructure/ShopDemo.Orders.Infraestructure.csproj reference Source/ShopDemo.Shared/ShopDemo.Shared.csproj
dotnet add Source/Orders/ShopDemo.Orders.Infraestructure/ShopDemo.Orders.Infraestructure.csproj package Microsoft.EntityFrameworkCore
dotnet add Source/Orders/ShopDemo.Orders.Infraestructure/ShopDemo.Orders.Infraestructure.csproj package Npgsql.EntityFrameworkCore.PostgreSQL

# Api
dotnet add Source/Orders/ShopDemo.Orders.Api/ShopDemo.Orders.Api.csproj reference Source/Orders/ShopDemo.Orders.Infraestructure/ShopDemo.Orders.Infraestructure.csproj
dotnet add Source/Orders/ShopDemo.Orders.Api/ShopDemo.Orders.Api.csproj reference Source/Orders/ShopDemo.Orders.Application/ShopDemo.Orders.Application.csproj
dotnet add Source/Orders/ShopDemo.Orders.Api/ShopDemo.Orders.Api.csproj package Swashbuckle.AspNetCore
dotnet add Source/Orders/ShopDemo.Orders.Api/ShopDemo.Orders.Api.csproj package Microsoft.EntityFrameworkCore.Design
```
...
COPY ["Source/ShopDemo.Shared/ShopDemo.Shared.csproj", "Source/ShopDemo.Shared/"]
