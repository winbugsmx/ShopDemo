...
| Regenerar PNG tras editar | `Source/scripts/docs/Export-TeoriaDiagrams.ps1` y luego `Activate-TeoriaDiagramImages.ps1` |

### Formato en cada capítulo

```markdown
![Diagrama: 02-monolito-modular](./images/diagrams/02-monolito-modular.png)

> *Fuente editable (Mermaid):* [02-monolito-modular.mermaid](./diagrams/02-monolito-modular.mermaid)
```
...
```powershell
cd I:\Curso\ShopDemo\Source\scripts\docs
