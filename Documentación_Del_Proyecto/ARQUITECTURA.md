...
├──────────────────────────────────────────────────────────────────────────────┤
│  Orquestación — Source/Aspire/ShopDemo.AppHost                                      │
...
|---|---|---|---|
| **Docker Compose** | Etapas 1–5; un servicio aislado | `docker compose up --build` en cada `*.Api/` | 1 API + su PostgreSQL (+ Azurite en Source/Inventory/Analytics) |
| **Aspire AppHost** | Etapa 6; stack integrado | `dotnet run --project Source/Aspire/ShopDemo.AppHost` | Catalog, Orders, Inventory, Analytics + PG + Azurite |
| **dotnet run** | Depuración unitaria | `dotnet run --project <Api>.csproj` | 1 API (requiere BD/dependencias manuales) |
| **MCP Gateway** | Etapa 14+; agentes IA | `dotnet run --project Source/AI/ShopDemo.Mcp.Api` | MCP :8005 (requiere Catalog, Inventory, Analytics) |
...
|---|---|---|---|
| Catalog | `Source/Catalog/.../appsettings.json` | `.env.example` → `.env` | Opcional |
| Orders | `Source/Orders/.../appsettings.json` | `.env.example` → `.env` | Opcional |
| Inventory | `Source/Inventory/.../appsettings.json` | `.env.example` → `.env` | Opcional |
| Analytics | `Source/Aspire/.../appsettings.json` | `.env.example` → `.env` | Opcional |
...
La solución (`Source/ShopDemo.slnx`) contiene **17 proyectos**:
...
**Documentación:** [Documentación_Del_Proyecto/analytics/](./analytics/) · [INTEGRACION-ASPIRE.md](./INTEGRACION-ASPIRE.md)
...
**Documentación:** [Documentación_Del_Proyecto/catalog/](./catalog/)
...
**Documentación:** [Documentación_Del_Proyecto/orders/](./orders/)
...
**Documentación:** [Documentación_Del_Proyecto/inventory/](./inventory/)
...
**Documentación:** [Documentación_Del_Proyecto/analytics/](./analytics/)
...
| Atributo | Valor |
|---|---|
| Acoplamiento con Source/Catalog, Source/Orders, Source/Inventory | Solo asíncrono (mismo Event Hub) |
...
**Documentación:** [Documentación_Del_Proyecto/integracion-ia/](./integracion-ia/) · [Source/AI/README.md](../Source/AI/README.md)
...
Docker: `Source/AI/ShopDemo.Mcp.Api/docker-compose.yml`  
...
|---|---|---|---|---|
| Catalog | `Source/Catalog/ShopDemo.Catalog.Api/` | 8001 | 5433 | Health `/health` |
| Orders | `Source/Orders/ShopDemo.Orders.Api/` | 8002 | 5434 | `InventoryApi__BaseUrl` → host |
| Inventory | `Source/Inventory/ShopDemo.Inventory.Api/` | 8003 | 5435 | Incluye Azurite |
| Analytics | `Source/Aspire/ShopDemo.Analytics.Api/` | 8004 | — | Azurite en compose |
| MCP Gateway | `Source/AI/ShopDemo.Mcp.Api/` | 8005 | — | URLs de APIs en `.env` |
...
|---|---|---|
| AppHost | `Source/Aspire/ShopDemo.AppHost/` | Arranque unificado de 4 APIs + infra |
| ServiceDefaults | `Source/Aspire/ShopDemo.ServiceDefaults/` | Telemetría y health |
| Analytics | `Source/Aspire/ShopDemo.Analytics.Api/` | Observador Event Hubs |
...
| Despliegue Docker → Azure (ACA) | Documentado | Guía en `Documentación_Del_Proyecto/despliegue/azure/` |
| Despliegue Docker → AWS (ECS) | Documentado | Guía en `Documentación_Del_Proyecto/despliegue/aws/` |
...
| Integración IA + despliegue MCP | Documentado + código | `Source/AI/`, `k8s/{local,azure,aws}/mcp/` |
...
5. **Referencias a Shared:** los proyectos Domain referencian `../../Source/ShopDemo.Shared/ShopDemo.Shared.csproj` desde subcarpetas `Source/Catalog/`, `Source/Orders/`, `Source/Inventory/`.
