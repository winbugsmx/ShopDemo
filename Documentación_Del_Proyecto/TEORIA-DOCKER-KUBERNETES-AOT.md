...
| **LoadBalancer** | IP externa (cloud) | Exponer Source/Catalog/Orders al público |
...
```bash
dotnet publish Source/Catalog/ShopDemo.Catalog.Api/ShopDemo.Catalog.Api.csproj \
...
- [Kubernetes — conceptos](https://kubernetes.io/Documentación_Del_Proyecto/concepts/)
