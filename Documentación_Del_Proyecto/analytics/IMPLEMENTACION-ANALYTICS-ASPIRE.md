...
Esta integración agrega **3 proyectos nuevos** bajo `Source/Aspire/`:
...
dotnet new classlib -n ShopDemo.ServiceDefaults -o Source/Aspire/ShopDemo.ServiceDefaults -f net10.0
```

### 2.3 Paquetes NuGet

```bash
dotnet add Source/Aspire/ShopDemo.ServiceDefaults package Microsoft.Extensions.Http.Resilience --version 10.0.0
dotnet add Source/Aspire/ShopDemo.ServiceDefaults package Microsoft.Extensions.ServiceDiscovery --version 10.0.0
dotnet add Source/Aspire/ShopDemo.ServiceDefaults package OpenTelemetry.Exporter.OpenTelemetryProtocol --version 1.12.0
dotnet add Source/Aspire/ShopDemo.ServiceDefaults package OpenTelemetry.Extensions.Hosting --version 1.12.0
dotnet add Source/Aspire/ShopDemo.ServiceDefaults package OpenTelemetry.Instrumentation.AspNetCore --version 1.12.0
dotnet add Source/Aspire/ShopDemo.ServiceDefaults package OpenTelemetry.Instrumentation.Http --version 1.12.0
dotnet add Source/Aspire/ShopDemo.ServiceDefaults package OpenTelemetry.Instrumentation.Runtime --version 1.12.0
```
...
```bash
dotnet new webapi -n ShopDemo.Analytics.Api -o Source/Aspire/ShopDemo.Analytics.Api -f net10.0

dotnet add Source/Aspire/ShopDemo.Analytics.Api reference Source/Aspire/ShopDemo.ServiceDefaults/ShopDemo.ServiceDefaults.csproj
dotnet add Source/Aspire/ShopDemo.Analytics.Api reference Source/ShopDemo.Shared/ShopDemo.Shared.csproj

dotnet add Source/Aspire/ShopDemo.Analytics.Api package Azure.Messaging.EventHubs --version 5.12.2
dotnet add Source/Aspire/ShopDemo.Analytics.Api package Azure.Messaging.EventHubs.Processor --version 5.12.2
dotnet add Source/Aspire/ShopDemo.Analytics.Api package Azure.Storage.Blobs --version 12.26.0
dotnet add Source/Aspire/ShopDemo.Analytics.Api package Microsoft.AspNetCore.OpenApi --version 10.0.0
dotnet add Source/Aspire/ShopDemo.Analytics.Api package Swashbuckle.AspNetCore --version 10.2.1
```
...
dotnet add Source/Aspire/ShopDemo.AppHost reference Source/Catalog/ShopDemo.Catalog.Api/ShopDemo.Catalog.Api.csproj
dotnet add Source/Aspire/ShopDemo.AppHost reference Source/Orders/ShopDemo.Orders.Api/ShopDemo.Orders.Api.csproj
dotnet add Source/Aspire/ShopDemo.AppHost reference Source/Inventory/ShopDemo.Inventory.Api/ShopDemo.Inventory.Api.csproj
dotnet add Source/Aspire/ShopDemo.AppHost reference Source/Aspire/ShopDemo.Analytics.Api/ShopDemo.Analytics.Api.csproj
```
...
Agregar carpeta `/Aspire/` en `Source/ShopDemo.slnx`:
...
Editar `Source/Aspire/ShopDemo.AppHost/appsettings.Development.json` con la connection string obtenida en [INTEGRACION-AZURE-EVENT-HUBS.md](../INTEGRACION-AZURE-EVENT-HUBS.md).
...
| Componente | Estado |
|---|---|
| `Source/Catalog/ShopDemo.Catalog.Domain` | Sin cambios |
| `Source/Catalog/ShopDemo.Catalog.Application` | Sin cambios |
| `Source/Orders/ShopDemo.Orders.*` (Domain, Application) | Sin cambios |
| `Source/Inventory/ShopDemo.Inventory.*` (Domain, Application) | Sin cambios |
...
```bash
docker build -f Source/Aspire/ShopDemo.Analytics.Api/Dockerfile -t shopdemo-analytics:latest .
```

Aspire puede generar contenedores con `dotnet publish Source/Aspire/ShopDemo.AppHost -p:PublishProfile=DefaultContainer` para exploración; el release del curso **no** depende de `azd up`.
