...
**Política ECS** — pegar contenido de [`Source/scripts/aws/iam-policy-shopdemo-lab-ecs.json`](../../../Source/scripts/aws/iam-policy-shopdemo-lab-ecs.json):
...
**Política EKS** — pegar [`Source/scripts/aws/iam-policy-shopdemo-lab-eks.json`](../../../Source/scripts/aws/iam-policy-shopdemo-lab-eks.json):
