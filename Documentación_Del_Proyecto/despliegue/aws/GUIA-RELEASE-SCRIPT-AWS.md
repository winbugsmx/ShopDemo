...
| **Script** | [`Source/scripts/aws/Deploy-AwsShopDemo.ps1`](../../../Source/scripts/aws/Deploy-AwsShopDemo.ps1) |
| **Modos** | `ECS` · `EKS` · `All` |
...
docker build -t shopdemo-catalog:$TAG -f Source/Catalog/ShopDemo.Catalog.Api/Dockerfile Source
docker tag shopdemo-catalog:$TAG "$ECR/shopdemo-catalog:$TAG"
docker push "$ECR/shopdemo-catalog:$TAG"

docker build -t shopdemo-orders:$TAG -f Source/Orders/ShopDemo.Orders.Api/Dockerfile Source
docker tag shopdemo-orders:$TAG "$ECR/shopdemo-orders:$TAG"
docker push "$ECR/shopdemo-orders:$TAG"

docker build -t shopdemo-inventory:$TAG -f Source/Inventory/ShopDemo.Inventory.Api/Dockerfile Source
...
Estado guardado en `Source/scripts/aws/.deploy-state.json`.
...
| 10 | Genera `Source/scripts/aws/deploy-eks-report.json` |
...
Referencia validada: [`deploy-eks-free-tier-report.json`](../../../Source/scripts/aws/deploy-eks-free-tier-report.json)
