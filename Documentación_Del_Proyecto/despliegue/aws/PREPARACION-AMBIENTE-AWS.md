...
| [kubectl](https://kubernetes.io/Documentación_Del_Proyecto/tasks/tools/) | 1.28+ | EKS | `kubectl version --client` |
| [Helm](https://helm.sh/Documentación_Del_Proyecto/intro/install/) | 3.x | EKS (opcional; perfil lab sin Ingress) | `helm version` |
