...
| [kubectl](https://kubernetes.io/Documentación_Del_Proyecto/tasks/tools/) | — | ✓ | `kubectl version --client` |
| [Helm](https://helm.sh/Documentación_Del_Proyecto/intro/install/) | — | ✓ | `helm version` |
