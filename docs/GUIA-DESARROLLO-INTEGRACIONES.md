...
5. Tras cada etapa: `dotnet build ShopDemo.slnx` y la validación indicada en la tabla.
...
Archivo: `docs/ShopDemo.postman_collection.json`
...
| Archivo | Para qué sirve |
|---|---|
| `Catalog/.../Dockerfile` | Imagen de la API |
| `Catalog/.../docker-compose.yml` | API + PostgreSQL en 8001/5433 |
...
# o docker compose en Orders/ShopDemo.Orders.Api
```
...
| # | Verificación |
|---|---|
| 1 | `dotnet build ShopDemo.slnx` sin errores |
