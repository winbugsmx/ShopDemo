...
**Archivo:** `Catalog/ShopDemo.Catalog.Api/docker-compose.yml`
...
**Archivo:** `Orders/ShopDemo.Orders.Api/docker-compose.yml`
...
**Archivo:** `Inventory/ShopDemo.Inventory.Api/docker-compose.yml`
...
**Archivo a crear:** `ShopDemo.Shared/Messaging/IntegrationEventEnvelope.cs`
...
**Verificación:** `dotnet build ShopDemo.Shared/ShopDemo.Shared.csproj` sin errores.
...
dotnet add Catalog/ShopDemo.Catalog.Infraestructure/ShopDemo.Catalog.Infraestructure.csproj \
...
**Archivo:** `Catalog/ShopDemo.Catalog.Infraestructure/Messaging/EventHubsDomainEventPublisher.cs`
...
**Archivo:** `Catalog/ShopDemo.Catalog.Api/appsettings.json`
...
**Para activar Event Hubs en contenedor** — edita `Catalog/ShopDemo.Catalog.Api/.env`:
...
```bash
docker compose -f Catalog/ShopDemo.Catalog.Api/docker-compose.yml logs catalog-service
```
...
```bash
dotnet add Orders/ShopDemo.Orders.Infraestructure/ShopDemo.Orders.Infraestructure.csproj \
  package Azure.Messaging.EventHubs
...
**Archivo:** `Orders/ShopDemo.Orders.Infraestructure/Messaging/EventHubsDomainEventPublisher.cs`
...
**Archivo:** `Orders/ShopDemo.Orders.Infraestructure/DependencyInjection.cs`
...
**Archivo:** `Orders/ShopDemo.Orders.Api/appsettings.json` — mantiene `EventHubs:Enabled: false` por defecto.

**Para activar en contenedor** — edita `Orders/ShopDemo.Orders.Api/.env`:
...
```bash
dotnet add Inventory/ShopDemo.Inventory.Infrastructure/ShopDemo.Inventory.Infrastructure.csproj \
  package Azure.Messaging.EventHubs
...
**Archivo:** `Inventory/ShopDemo.Inventory.Infrastructure/Adapters/Messaging/EventHubsIntegrationEventPublisher.cs`
...
**Archivo:** `Inventory/ShopDemo.Inventory.Infrastructure/Adapters/Messaging/CatalogEventsProcessor.cs`
...
**Archivo:** `Inventory/ShopDemo.Inventory.Infrastructure/DependencyInjection.cs`
...
**Archivo:** `Inventory/ShopDemo.Inventory.Api/appsettings.json` — valores por defecto con `Enabled: false`.

**Para activar en contenedor** — edita `Inventory/ShopDemo.Inventory.Api/.env`:
...
1. **Inventory** (`docker compose up` en `Inventory/ShopDemo.Inventory.Api`)
2. **Catalog** (`docker compose up` en `Catalog/ShopDemo.Catalog.Api`)
3. **Orders** (opcional)
