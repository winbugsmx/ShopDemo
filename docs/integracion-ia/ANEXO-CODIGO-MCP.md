...
> Copia cada bloque en `AI/ShopDemo.Mcp.Api/`. Requiere Catalog, Inventory y Analytics en ejecución.
...
---
## `AI/ShopDemo.Mcp.Api/Program.cs`
...
---
## `AI/ShopDemo.Mcp.Api/Tools/ShopDemoMcpTools.cs`
...
---
## `AI/ShopDemo.Mcp.Api/ShopDemo.Mcp.Api.csproj`
