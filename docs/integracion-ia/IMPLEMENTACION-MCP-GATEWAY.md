...
dotnet new webapi -n ShopDemo.Mcp.Api -o AI/ShopDemo.Mcp.Api -f net10.0
dotnet add AI/ShopDemo.Mcp.Api package ModelContextProtocol.AspNetCore
dotnet add AI/ShopDemo.Mcp.Api package Microsoft.AspNetCore.OpenApi
```

Agregar el proyecto a `ShopDemo.slnx` en carpeta `/AI/`.
...
**Ruta:** `AI/ShopDemo.Mcp.Api/Program.cs`
...
**Ruta:** `AI/ShopDemo.Mcp.Api/Tools/ShopDemoMcpTools.cs`
