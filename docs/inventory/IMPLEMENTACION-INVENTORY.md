...
dotnet new classlib -n ShopDemo.Inventory.Domain -o Inventory/ShopDemo.Inventory.Domain -f net10.0
dotnet new classlib -n ShopDemo.Inventory.Application -o Inventory/ShopDemo.Inventory.Application -f net10.0
dotnet new classlib -n ShopDemo.Inventory.Infrastructure -o Inventory/ShopDemo.Inventory.Infrastructure -f net10.0
dotnet new webapi -n ShopDemo.Inventory.Api -o Inventory/ShopDemo.Inventory.Api -f net10.0

# Domain
dotnet add Inventory/ShopDemo.Inventory.Domain/ShopDemo.Inventory.Domain.csproj reference ShopDemo.Shared/ShopDemo.Shared.csproj

# Application
dotnet add Inventory/ShopDemo.Inventory.Application/ShopDemo.Inventory.Application.csproj reference Inventory/ShopDemo.Inventory.Domain/ShopDemo.Inventory.Domain.csproj
dotnet add Inventory/ShopDemo.Inventory.Application/ShopDemo.Inventory.Application.csproj reference ShopDemo.Shared/ShopDemo.Shared.csproj

# Infrastructure
dotnet add Inventory/ShopDemo.Inventory.Infrastructure/ShopDemo.Inventory.Infrastructure.csproj reference Inventory/ShopDemo.Inventory.Application/ShopDemo.Inventory.Application.csproj
dotnet add Inventory/ShopDemo.Inventory.Infrastructure/ShopDemo.Inventory.Infrastructure.csproj reference Inventory/ShopDemo.Inventory.Domain/ShopDemo.Inventory.Domain.csproj
dotnet add Inventory/ShopDemo.Inventory.Infrastructure/ShopDemo.Inventory.Infrastructure.csproj reference ShopDemo.Shared/ShopDemo.Shared.csproj
dotnet add Inventory/ShopDemo.Inventory.Infrastructure/ShopDemo.Inventory.Infrastructure.csproj package Microsoft.EntityFrameworkCore
dotnet add Inventory/ShopDemo.Inventory.Infrastructure/ShopDemo.Inventory.Infrastructure.csproj package Npgsql.EntityFrameworkCore.PostgreSQL

# Api
dotnet add Inventory/ShopDemo.Inventory.Api/ShopDemo.Inventory.Api.csproj reference Inventory/ShopDemo.Inventory.Infrastructure/ShopDemo.Inventory.Infrastructure.csproj
dotnet add Inventory/ShopDemo.Inventory.Api/ShopDemo.Inventory.Api.csproj reference Inventory/ShopDemo.Inventory.Application/ShopDemo.Inventory.Application.csproj
dotnet add Inventory/ShopDemo.Inventory.Api/ShopDemo.Inventory.Api.csproj package Swashbuckle.AspNetCore
dotnet add Inventory/ShopDemo.Inventory.Api/ShopDemo.Inventory.Api.csproj package Microsoft.EntityFrameworkCore.Design
```

### 2.3 Agregar a la solución

En `ShopDemo.slnx`, añadir la carpeta `/Inventory/` con los cuatro proyectos.
...
**Archivo:** `Orders/ShopDemo.Orders.Application/Ports/IInventoryService.cs`
...
**Archivo:** `Orders/ShopDemo.Orders.Infraestructure/Integrations/InventoryHttpClient.cs`
...
En `Orders/ShopDemo.Orders.Api/appsettings.json`:
...
2. `dotnet run --project Inventory/ShopDemo.Inventory.Api`
...
## Comparación con Catalog/Orders
