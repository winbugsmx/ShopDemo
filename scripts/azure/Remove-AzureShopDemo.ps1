...
.DESCRIPTION
    Ref: docs/despliegue/azure/IMPLEMENTACION-DESPLIEGUE-AZURE.md §16
...
Write-Host "Ref: docs/despliegue/azure/IMPLEMENTACION-DESPLIEGUE-AZURE.md §16" -ForegroundColor DarkGray
Write-Host ""
